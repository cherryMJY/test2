...
$(function () {
    ...
    $('#myModa2').on('shown.bs.modal', function (event) {
         ...
         var repo_name = btnThis.parent().parent().parent().parent().find(".repo_name_a").html();
    ...
    $(".repo_name_a").click(function () {
        var repo_id = $(this).parent().parent().find(".repo_id").attr("id");
        $.post('/index/get_repo_id',
            {
                repo_id: repo_id,
            },
            function (data){
        ...
        // window.location.href = '/index/knowledge_definition?repo_id=' + repo_id;
    })
});